		...
		if (canResize && !Client.getInstance().getMousePos().equals(mouseLast)) {
			if (isResizing()) {
				...
				if (newDim.getWidth() > minSize.getWidth() && (maxSize.getWidth() == 0 || newDim.getWidth() < maxSize.getWidth())) {
					if (newDim.getWidth() != dimension.getWidth())
						setDimension(newDim.getWidth(), dimension.getHeight());
				...
				if (newDim.getHeight() > minSize.getHeight() && (maxSize.getHeight() == 0 || newDim.getHeight() < maxSize.getHeight())) {
					if (newDim.getHeight() != dimension.getHeight())
						setDimension(dimension.getWidth(), newDim.getHeight());
