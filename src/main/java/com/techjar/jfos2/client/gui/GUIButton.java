...
public class GUIButton extends GUIText {
	...
	public void render() {
		...
		if (font != null && color != null)
			font.drawString(getPosition().getX() + ((dimension.getWidth() - font.getWidth(text.toString())) / 2), getPosition().getY() + ((dimension.getHeight() - font.getHeight(text.toString())) / 2), text.toString(), Util.convertColor(color));
	}
